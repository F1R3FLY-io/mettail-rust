...
The `decompose_into_cek` method bridges language-specific AST nodes to the
generic `CekEvaluator`. It is defined on the `Language` trait and
auto-generated by the `language!` macro.
