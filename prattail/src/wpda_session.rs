...
impl<W: Semiring + crate::automata::semiring::TropicalDeltaWeight> WpdaIncrementalSession<W> {
...
impl<W: Semiring + crate::automata::semiring::TropicalDeltaWeight> Default for WpdaIncrementalSession<W> {
    fn default() -> Self {
        Self::new(1)
    }
}
