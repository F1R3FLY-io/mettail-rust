...
// ══════════════════════════════════════════════════════════════════════════════
// Stage 10.8 (2026-05-05): SpilloverTrainer struct + impl DELETED.
//
// The B5 trainer bridged C1 WeightCorrection events to RuleWeights, learning
// from trampoline-era NFA spillover events. NFA spillover is gone (Stage 10.6);
// the trainer's input signal source no longer exists. The training infrastructure
// (RuleWeights, train_from_corrections, WeightCorrection) is preserved for
// future use with Walker-derived correction signals (e.g., AmbiguityFanout
// resolution outcomes).
// ══════════════════════════════════════════════════════════════════════════════
...
mod tests {
    ...
    // Stage 10.8 (2026-05-05): B5 SpilloverTrainer tests DELETED. The trainer
    // struct + impl were removed (no input signal source post-Stage-10.6).
