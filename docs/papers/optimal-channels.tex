...
\begin{multline}\label{eq:context-rule}
...
\begin{multline*}
  \Let{tc}{\reflect{T_{M}(K)}}{\,
    \mathsf{for}\,((\sem{L_{1}}, \ldots, \sem{L_{n}}) \Leftarrow tc)\, \\
    \{\,\Send{tc}{\sem{K'}(\sem{R_{1}}, \ldots, \sem{R_{n}})}\,\}
  \,}.
\end{multline*}
...
\begin{multline*}
  \Let{tc}{\reflect{T_{M}(K)}}{\,
    \mathsf{for}\,((\sem{L_{1}}, \ldots, \sem{L_{n}}) \Leftarrow tc)\, \\
    \bigl\{\,\bigl(\bigparallel_{i, P \in \pi(L_{i}), |P| \ge 2} \Match{P}(L_{i})\bigr)
      \mid \mathit{enable\text{-}guarded}(\Send{tc}{\sem{K'}(\ldots)})\,\bigr\}
  \,},
\end{multline*}
