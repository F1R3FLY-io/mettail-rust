...
`sim_rholang_proptest_campaign` (50 cases of `arb_proc(3)`, ≤ 500 chars) exceeds the 1800 s CI cap stochastically — the ~0.4 % pathological tail is deep-`@` terms. The deterministic reproduction is the grouping ladder
