...
| INV-10 | RHS constructor reflection preserves tag / arity / structure | Satisfied | `RhoAstSendBoundary`, `RholangAstLowering`; the reflected-EList ABI — [19](19-in-rho-binder-beta-substitution.md) §3 |
