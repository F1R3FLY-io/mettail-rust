...
`BoundedByCycleCut` reports for production default execution and rejects
Ascent-shaped seeded facts on the Dovetail path, which keeps Dovetail reports,
Ascent graphs, and Rho observations separate at the runtime API boundary.
