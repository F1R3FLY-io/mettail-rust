...
- removal of the Ascent reference/oracle path;
...
legend right
  <#DBEAFE> coverage inputs
  <#DCFCE7> Dovetail facts
  <#BBF7D0> identity preservation
  <#FEF3C7> Rho lowering
  <#FDE68A> guard behavior
  <#FBCFE8> parallel scheduling
  <#EDE9FE> oracle
  <#F3E8FF> host runtime boundary
  <#FCE7F3> final theorem
endlegend
@enduml
```
