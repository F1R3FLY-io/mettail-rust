// AUTO-GENERATED by language! macro for Class3Opt (unit) — do not edit
...
#[test]
fn class3opt_language_instantiates() {
    let lang = Class3OptLanguage;
    assert_eq!(lang.name(), "Class3Opt");
}

#[test]
fn class3opt_metadata_populated() {
    let lang = Class3OptLanguage;
...
// Skipped unit test for PInputsOptTagged (Proc) — constructor too complex to construct statically

#[test]
fn unit_class3opt_auto_proc_pvar() {
    mettail_runtime::clear_var_cache();
    let term = Proc::PVar(
...
#[test]
fn unit_class3opt_auto_name_nvar() {
    mettail_runtime::clear_var_cache();
    let term = Name::NVar(
        mettail_runtime::OrdVar(
            mettail_runtime::Var::Free(
