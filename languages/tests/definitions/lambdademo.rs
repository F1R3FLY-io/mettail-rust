...
language! {
    ...
    options {
        ...
        // suite INLINE (the opt-in `lambdademo_generated_tests!` wrapper) instead of writing
        // `languages/tests/gen_lambdademo_*.rs`, whose `use mettail_languages::lambdademo::*;`
        ...
        hosted_in: "tests/definitions/lambdademo.rs",
