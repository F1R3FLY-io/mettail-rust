...
language! {
    ...
    options {
        ...
        // suite INLINE (the opt-in `inoutdemo_generated_tests!` wrapper) instead of writing
        // `languages/tests/gen_inoutdemo_*.rs`, whose `use mettail_languages::inoutdemo::*;`
        ...
        hosted_in: "tests/definitions/inoutdemo.rs",
