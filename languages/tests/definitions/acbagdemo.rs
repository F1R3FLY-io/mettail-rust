...
language! {
    ...
    options {
        ...
        // suite INLINE (the opt-in `acbagdemo_generated_tests!` wrapper) instead of writing
        // `languages/tests/gen_acbagdemo_*.rs`, whose `use mettail_languages::acbagdemo::*;`
        ...
        hosted_in: "tests/definitions/acbagdemo.rs",
