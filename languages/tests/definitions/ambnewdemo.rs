...
language! {
    ...
    options {
        ...
        // suite INLINE (the opt-in `ambnewdemo_generated_tests!` wrapper) instead of writing
        // `languages/tests/gen_ambnewdemo_*.rs`, whose `use mettail_languages::ambnewdemo::*;`
        ...
        hosted_in: "tests/definitions/ambnewdemo.rs",
