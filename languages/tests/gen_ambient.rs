// AUTO-GENERATED by language! macro for Ambient — do not edit
...
fn sim_ambient_normal_form_reachability() {
    ...
    let test_inputs: Vec<&str> = vec!["0", "in( 1 , 1 )", "out( 1 , 1 )", "open( 1 , 1 )", "1 [ 1 ]", "new ( 1 , 1 )"];
