// AUTO-GENERATED by language! macro for GuardedRho — do not edit
...
#[test]
fn unit_guardedrho_pguardedinput() {
    mettail_runtime::clear_var_cache();
...
#[test]
fn unit_guardedrho_auto_numlit() {
