// AUTO-GENERATED by language! macro for CtxDemo (rewrite) — do not edit
...
#[test]
fn rewrite_ctxdemo_flip() {
    let _lang = CtxDemoLanguage;
...
// Rewrite test for WrapCong skipped: congruence rule (needs triggering context)
#[test]
fn rewrite_ctxdemo_wrapcong() {
    let _lang = CtxDemoLanguage;
