...
use mettail_languages::rhocalc::RhoCalcDovetailOp as Op;
...
fn display_label_matches_string_path_projection() {
    ...
    assert_eq!(format!("{}", Op::Proc_Err), "RhoCalc::Proc::Err");
    assert_eq!(format!("{}", Op::Int_NumLit(3)), "RhoCalc::Int::NumLit(3)");
}
