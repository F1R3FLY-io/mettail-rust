...
// Dead rules detected by WFST analysis: {"Bool::HasMap", "Bool::GtFloat", "UInt32::BoolToUInt32", "BigInt::SubBigInt", "Int::BoolToInt", "Str::FloatToStr", "BoolToBigRat", "Int::LenList", "Proc::ProcMap", "Proc::ProcStr", "Bool::GtEqInt", "BigRat::FloatToBigRat", "Int::BitOrInt", "BigRat::BigratCast", "Float::StrToFloat", "BigRat::BoolToBigRat", "Int::Fact", "Int::PowInt", "Fixed::MulFixed", "Bool::EqFixed", "ProcList", "Bool::LtBool", "Float::AddFloat", "Bool::LtEqFloat", "Fixed::BitNotFixed", "Bool::LtEqStr", "Bool::Xor", "Bool::LtInt", "Bool::BoolId", "BigRat::UInt32ToBigRat", "Int::IntId", "Int::Tern", "Proc::ElemList", "Bool::NeStr", "Bool::GtStr", "ProcBool", "Proc::ProcUInt32", "Bool::EqFloat", "List::ValuesMap", "BigRat::Fraction", "BigRat::MulBigRat", "Bool::GtEqBool", "Float::SinFloat", "List::ConcatList", "Bag::RemoveBag", "Bool::ProcToBool", "Bool::LtEqFixed", "Bool::LtFloat", "Float::IntToFloat", "Int::StrToInt", "Bool::StrToBool", "Bag::BagLit", "List::DeleteList", "Bag::UnionBag", "Float::DivFloat", "Int::CustomOp", "Int::BitNotInt", "Bool::GtFixed", "BigInt::CastErrBigInt", "ProcBigRat", "Float::ExpFloat", "Bool::GtBool", "Int::FloatToInt", "List::ListLit", "Int::DivInt", "Proc::ProcBag", "ProcMap", "Float::FloatBin", "Bool::GtEqStr", "BigRat::BitOrBigRat", "BigRat::IntToBigRat", "Map::MergeMap", "BigIntToBigRat", "Fixed::BitAndFixed", "Fixed::SubFixed", "BigRat::BitNotBigRat", "FloatToBigRat", "Proc::ProcList", "Int::BitAndInt", "Int::AddInt", "Fixed::BitOrFixed", "BigRat::BitAndBigRat", "Bool::GtInt", "BigRat::DivBigRat", "BigRat::FixedToBigRat", "Float::CosFloat", "BigRat::AddBigRat", "UInt32::BitOrUInt32", "FixedToBigRat", "Bool::LtEqBool", "UInt32::BitNotUInt32", "Float::FloatId", "Fixed::AddFixed", "Bool::IntToBool", "Fixed::FixedBin", "Bool::LtFixed", "BigInt::UInt32ToBigInt", "Int::MulInt", "ProcInt", "Int::SubInt", "Float::PowFloat", "Str::Concat", "Float::BoolToFloat", "ProcUInt32", "BigInt::IntToBigInt", "Bool::EqBool", "ProcStr", "Float::NegFloat", "BigRat::NegBigRat", "Fixed::DivFixed", "Str::IntToStr", "Map::DeleteMap", "UInt32::AddUInt32", "Bool::Or", "Str::StrId", "Bool::Not", "UInt32::UIntBin", "UInt32ToBigInt", "BoolToBigInt", "UInt32::CastErrUInt32", "Map::PutMap", "Str::AddStr", "Proc::ProcFixed", "IntToBigRat", "BigInt::BoolToBigInt", "BigInt::NegBigInt", "Proc::ProcBigRat", "Int::Len", "Fixed::NegFixed", "Bool::NeInt", "BigInt::BitAndBigInt", "ProcBigInt", "Proc::ProcFloat", "UInt32ToBigRat", "UInt32::BitAndUInt32", "Int::Neg", "Bool::GtEqFloat", "Bool::GtEqFixed", "Float::LnFloat", "Str::ProcToStr", "Int::CountBag", "BigRat::BigIntToBigRat", "Bool::NeFixed", "Int::LenMap", "List::KeysMap", "BigInt::BigintCast", "BoolToUInt32", "Bool::LtStr", "BigInt::BitNotBigInt", "Bool::NeFloat", "Proc::GetMap", "Proc::ProcInt", "Int::IntBin", "Bool::EqInt", "Bool::And", "Bag::DiffBag", "Proc::ProcBigInt", "BigInt::BitOrBigInt", "Bool::FloatToBool", "IntToBigInt", "Fixed::ModFixed", "Bool::EqStr", "Bool::NeBool", "Float::MulFloat", "Proc::ProcBool", "ProcBag", "Int::ModInt", "Float::SubFloat", "Str::BoolToStr", "Map::MapLit", "BigRat::Err", "BigInt::AddBigInt", "Bool::LtEqInt"}
