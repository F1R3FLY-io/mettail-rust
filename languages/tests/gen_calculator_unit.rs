...
// Dead rules detected by WFST analysis: {"UInt32::BitAndUInt32", "Str::IntToStr", "Str::Concat", "Proc::ProcBigRat", "Int::BitOrInt", "Float::ExpFloat", "Int::CustomOp", "List::ValuesMap", "ProcInt", "Float::PowFloat", "Bool::GtBool", "BigRat::UInt32ToBigRat", "ProcList", "BigRat::BoolToBigRat", "ProcBool", "ProcBigInt", "Proc::ProcMap", "Int::IntId", "Int::LenMap", "Bool::NeFixed", "Int::Fact", "ProcBag", "Fixed::MulFixed", "Float::CosFloat", "Fixed::FixedBin", "Float::StrToFloat", "Map::PutMap", "BigRat::FixedToBigRat", "Float::LnFloat", "UInt32::UIntBin", "Bool::HasMap", "UInt32ToBigRat", "Bool::ProcToBool", "UInt32::BitNotUInt32", "Bool::EqBool", "Bool::LtEqFloat", "UInt32ToBigInt", "Map::DeleteMap", "BigRat::NegBigRat", "Proc::ProcUInt32", "BigInt::BoolToBigInt", "Bool::EqFloat", "UInt32::BoolToUInt32", "Bool::LtEqBool", "Bag::RemoveBag", "Fixed::DivFixed", "Fixed::SubFixed", "Str::AddStr", "Int::LenList", "Bool::LtEqInt", "BigRat::IntToBigRat", "ProcUInt32", "List::KeysMap", "List::DeleteList", "BigRat::BitOrBigRat", "Int::IntBin", "Bool::EqFixed", "BigInt::BitOrBigInt", "Bool::GtEqInt", "Proc::ProcFloat", "UInt32::BitOrUInt32", "BigInt::SubBigInt", "BigRat::Err", "Int::Neg", "Bool::LtFixed", "Int::BoolToInt", "BigRat::AddBigRat", "Proc::ElemList", "Proc::ProcStr", "Int::Tern", "Str::FloatToStr", "Bool::GtEqFixed", "Proc::ProcBool", "ProcStr", "Bool::GtEqBool", "UInt32::CastErrUInt32", "Bool::Xor", "Float::IntToFloat", "BigRat::BigratCast", "Proc::ProcBag", "Bool::GtEqStr", "Float::FloatId", "Int::StrToInt", "Int::MulInt", "BigInt::CastErrBigInt", "Proc::ProcList", "Bool::GtStr", "Bool::BoolId", "Int::DivInt", "Bool::StrToBool", "Fixed::BitAndFixed", "Bag::UnionBag", "BigInt::BigintCast", "BigRat::BitNotBigRat", "Fixed::AddFixed", "Int::PowInt", "BigInt::BitAndBigInt", "Bool::NeStr", "Bool::LtFloat", "Bool::NeInt", "Proc::ProcFixed", "UInt32::AddUInt32", "IntToBigInt", "Bool::FloatToBool", "Bool::LtStr", "BigRat::MulBigRat", "Proc::ProcBigInt", "IntToBigRat", "FixedToBigRat", "Int::BitNotInt", "BoolToBigInt", "Int::Len", "Float::NegFloat", "BigRat::BigIntToBigRat", "List::ListLit", "BigIntToBigRat", "Int::CountBag", "Bool::IntToBool", "Bool::GtFixed", "Str::BoolToStr", "ProcBigRat", "Str::StrId", "List::ConcatList", "Bool::LtEqFixed", "Bool::Not", "Bool::GtInt", "Str::ProcToStr", "Int::FloatToInt", "FloatToBigRat", "BoolToUInt32", "Bool::GtFloat", "Bool::EqStr", "Bool::LtInt", "Bag::BagLit", "ProcMap", "Bool::NeFloat", "Fixed::ModFixed", "Bool::Or", "BigInt::BitNotBigInt", "Fixed::BitOrFixed", "Float::DivFloat", "BigRat::Fraction", "BigInt::AddBigInt", "Int::SubInt", "Fixed::BitNotFixed", "Float::SinFloat", "Float::BoolToFloat", "Fixed::NegFixed", "BigInt::NegBigInt", "BigInt::IntToBigInt", "BigRat::DivBigRat", "Map::MapLit", "Float::SubFloat", "Int::BitAndInt", "Proc::ProcInt", "Bool::GtEqFloat", "Int::AddInt", "BigInt::UInt32ToBigInt", "BigRat::BitAndBigRat", "Bool::LtEqStr", "Bool::LtBool", "Bool::NeBool", "Float::MulFloat", "Float::AddFloat", "Proc::GetMap", "Bag::DiffBag", "Int::ModInt", "Bool::And", "Float::FloatBin", "Bool::EqInt", "BigRat::FloatToBigRat", "Map::MergeMap", "BoolToBigRat"}
