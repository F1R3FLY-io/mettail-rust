...
// Dead rules detected by WFST analysis: {"Bool::GtStr", "Float::NegFloat", "Map::DeleteMap", "Bag::DiffBag", "Fixed::BitAndFixed", "Int::IntBin", "UInt32::AddUInt32", "BigInt::BitOrBigInt", "Float::DivFloat", "Bool::GtInt", "UInt32::BitNotUInt32", "Bool::GtEqFixed", "Float::FloatId", "BigRat::Fraction", "Int::StrToInt", "Float::MulFloat", "Float::BoolToFloat", "BigRat::BitNotBigRat", "List::ConcatList", "ProcBag", "BigRat::BigIntToBigRat", "Int::IntId", "Int::Neg", "Map::MapLit", "UInt32::UIntBin", "Str::StrId", "Bool::EqFloat", "Str::ProcToStr", "Proc::ProcMap", "ProcBigInt", "BigRat::BigratCast", "Int::FloatToInt", "Bool::StrToBool", "BigRat::IntToBigRat", "Int::CountBag", "Float::LnFloat", "Int::PowInt", "UInt32::BoolToUInt32", "Fixed::ModFixed", "Bool::GtEqFloat", "Str::FloatToStr", "Float::SubFloat", "Bool::EqStr", "Int::BitOrInt", "UInt32::BitAndUInt32", "Int::CustomOp", "BigRat::Err", "Int::ModInt", "Int::LenList", "Str::Concat", "Bool::EqInt", "List::DeleteList", "BigInt::AddBigInt", "Proc::ProcBigInt", "Fixed::AddFixed", "Float::IntToFloat", "BigInt::BigintCast", "Bool::HasMap", "BigInt::BitNotBigInt", "Proc::ProcStr", "Fixed::FixedBin", "ProcStr", "Bool::Or", "Int::BitAndInt", "Proc::ProcFloat", "FloatToBigRat", "BoolToUInt32", "BigInt::UInt32ToBigInt", "Float::PowFloat", "BigIntToBigRat", "Bool::LtEqFixed", "Bool::LtFixed", "UInt32::BitOrUInt32", "Bool::EqBool", "BigInt::IntToBigInt", "Bag::RemoveBag", "Bool::GtEqInt", "Bool::LtEqBool", "Float::AddFloat", "Proc::ProcList", "BigRat::BitAndBigRat", "Int::BitNotInt", "Str::AddStr", "Int::Len", "Str::BoolToStr", "Int::Fact", "Proc::ProcUInt32", "Bool::LtFloat", "BigRat::BitOrBigRat", "Bool::GtEqStr", "Bool::NeInt", "Fixed::DivFixed", "Float::FloatBin", "Int::MulInt", "Map::MergeMap", "Bool::LtEqStr", "Fixed::MulFixed", "Bool::NeFloat", "Int::LenMap", "BigRat::UInt32ToBigRat", "Proc::ProcBigRat", "Proc::ProcInt", "ProcInt", "BigRat::MulBigRat", "UInt32ToBigInt", "Bool::FloatToBool", "ProcUInt32", "Bool::LtBool", "Fixed::BitNotFixed", "BigInt::SubBigInt", "Bool::NeBool", "Proc::GetMap", "Bool::LtEqInt", "Bag::UnionBag", "Int::SubInt", "Fixed::BitOrFixed", "Float::StrToFloat", "BigRat::AddBigRat", "Bool::NeFixed", "ProcList", "List::ListLit", "UInt32ToBigRat", "FixedToBigRat", "Bool::Not", "Bool::LtInt", "Int::BoolToInt", "BigInt::BitAndBigInt", "BigRat::FixedToBigRat", "Proc::ProcFixed", "Bool::GtEqBool", "Bool::GtFloat", "Float::SinFloat", "BigInt::NegBigInt", "Bool::IntToBool", "List::KeysMap", "Fixed::NegFixed", "Str::IntToStr", "UInt32::CastErrUInt32", "Proc::ElemList", "BoolToBigInt", "Fixed::SubFixed", "ProcBool", "BigInt::BoolToBigInt", "Proc::ProcBag", "ProcMap", "BigRat::BoolToBigRat", "Proc::ProcBool", "Int::Tern", "Bool::NeStr", "BoolToBigRat", "Bool::ProcToBool", "List::ValuesMap", "ProcBigRat", "Bool::GtBool", "Map::PutMap", "Float::ExpFloat", "IntToBigRat", "Bool::BoolId", "Bool::Xor", "Float::CosFloat", "Bool::EqFixed", "Bool::LtEqFloat", "IntToBigInt", "Bool::And", "Int::DivInt", "Bool::GtFixed", "Bag::BagLit", "BigRat::FloatToBigRat", "BigInt::CastErrBigInt", "BigRat::NegBigRat", "Int::AddInt", "Bool::LtStr", "BigRat::DivBigRat"}
