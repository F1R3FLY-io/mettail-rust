...
fn corpus_0_term() {
    ...
    // 1 — the term CONSTRUCTS.
    let term: Term = Term::Lam(mettail_runtime::Scope::from_parts_unsafe(mettail_runtime::Binder(mettail_runtime::get_or_create_var("a6")), std::sync::Arc::new(Term::TVar(mettail_runtime::OrdVar(mettail_runtime::Var::Free(mettail_runtime::get_or_create_var("a")))))));
