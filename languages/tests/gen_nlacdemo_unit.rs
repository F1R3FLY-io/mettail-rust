// AUTO-GENERATED by language! macro for NlAcDemo (unit) — do not edit
...
#[test]
fn nlacdemo_language_instantiates() {
    let lang = NlAcDemoLanguage;
    assert_eq!(lang.name(), "NlAcDemo");
}

#[test]
fn nlacdemo_metadata_populated() {
    let lang = NlAcDemoLanguage;
...
#[test]
fn unit_nlacdemo_auto_proc_pvar() {
    mettail_runtime::clear_var_cache();
...
#[test]
fn unit_nlacdemo_auto_bag_baglit() {
