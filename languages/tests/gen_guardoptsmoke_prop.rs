...
// AUTO-GENERATED by language! macro for GuardOptSmoke (prop) — do not edit
...
fn build_int_from_tape(reader: &mut TapeReader<'_>, depth: u32) -> Int {
    ...
    match choice {
        ...
        _ => {
            ...
            let f1: Option<std::sync::Arc<Guard>> = if reader.next_byte() & 1 == 0 {
                None
            } else {
                Some(std::sync::Arc::new(build_guard_from_tape(reader, child_depth)))
            };
            Int::PCheck(f0, f1)
        },
    }
