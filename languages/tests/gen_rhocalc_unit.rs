...
#[test]
fn unit_rhocalc_proc_spatialppar() {
    mettail_runtime::clear_var_cache();
    let term =
...
#[test]
fn unit_rhocalc_proc_rzgetpath() {
    mettail_runtime::clear_var_cache();
...
#[test]
fn unit_rhocalc_proc_rztonextleaf() {
    mettail_runtime::clear_var_cache();
...
#[test]
fn unit_rhocalc_proc_rzleafcount() {
    mettail_runtime::clear_var_cache();
