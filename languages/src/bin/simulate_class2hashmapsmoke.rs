// AUTO-GENERATED simulation binary for Class2HashMapSmoke — do not edit
...
#[derive(Parser)]
#[command(name = "simulate_class2hashmapsmoke")]
#[command(about = "Simulation runner for the Class2HashMapSmoke language")]
struct Args {
...
fn main() {
    ...
    let regression_path = PathBuf::from("simulate_class2hashmapsmoke.regressions");
    ...
    if args.verbose {
        eprintln!("Running simulation for Class2HashMapSmoke:");
    ...
    println!("=== Class2HashMapSmoke Simulation Results ===");
    println!("{}", results);
