// AUTO-GENERATED simulation binary for RhoCalc — do not edit
// Regenerated on each compilation of the language definition.
// Run with: cargo run --bin simulate_rhocalc -- [OPTIONS]

use clap::Parser;
use mettail_languages::rhocalc::strategies::arb_proc;
...
#[derive(Parser)]
#[command(name = "simulate_rhocalc")]
#[command(about = "Simulation runner for the RhoCalc language")]
struct Args {
...
fn main() {
    ...
    let regression_path = PathBuf::from("simulate_rhocalc.regressions");
    ...
    if args.verbose {
        eprintln!("Running simulation for RhoCalc:");
    ...
    println!("=== RhoCalc Simulation Results ===");
    println!("{}", results);
