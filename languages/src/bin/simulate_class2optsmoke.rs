// AUTO-GENERATED simulation binary for Class2OptSmoke — do not edit
// Regenerated on each compilation of the language definition.
// Run with: cargo run --bin simulate_class2optsmoke -- [OPTIONS]
...
mod class2optsmoke;
use class2optsmoke::strategies::arb_proc;
use class2optsmoke::Class2OptSmokeLanguage;
use mettail_runtime::Language;
use proptest::strategy::Strategy;
use std::path::PathBuf;

#[derive(Parser)]
#[command(name = "simulate_class2optsmoke")]
#[command(about = "Simulation runner for the Class2OptSmoke language")]
struct Args {
...
fn main() {
    ...
    let regression_path = PathBuf::from("simulate_class2optsmoke.regressions");
    ...
    if args.verbose {
        eprintln!("Running simulation for Class2OptSmoke:");
    ...
    println!("=== Class2OptSmoke Simulation Results ===");
    println!("{}", results);
