// AUTO-GENERATED simulation binary for OptSmoke — do not edit
...
#[derive(Parser)]
#[command(name = "simulate_optsmoke")]
#[command(about = "Simulation runner for the OptSmoke language")]
struct Args {
...
fn main() {
    ...
    let regression_path = PathBuf::from("simulate_optsmoke.regressions");
    ...
    if args.verbose {
        eprintln!("Running simulation for OptSmoke:");
    ...
    println!("=== OptSmoke Simulation Results ===");
    println!("{}", results);
