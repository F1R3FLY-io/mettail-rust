// AUTO-GENERATED simulation binary for Class2Multi — do not edit
...
#[derive(Parser)]
#[command(name = "simulate_class2multi")]
#[command(about = "Simulation runner for the Class2Multi language")]
struct Args {
...
fn main() {
    ...
    let regression_path = PathBuf::from("simulate_class2multi.regressions");
    ...
    if args.verbose {
        eprintln!("Running simulation for Class2Multi:");
    ...
    println!("=== Class2Multi Simulation Results ===");
    println!("{}", results);
