// AUTO-GENERATED simulation binary for ExtMath — do not edit
// Regenerated on each compilation of the language definition.
// Run with: cargo run --bin simulate_extmath -- [OPTIONS]

use clap::Parser;
use mettail_languages::extmath::strategies::arb_num;
use mettail_languages::extmath::ExtMathLanguage;
...
#[derive(Parser)]
#[command(name = "simulate_extmath")]
#[command(about = "Simulation runner for the ExtMath language")]
struct Args {
...
fn main() {
    ...
    let regression_path = PathBuf::from("simulate_extmath.regressions");
    ...
    if args.verbose {
        eprintln!("Running simulation for ExtMath:");
    ...
    println!("=== ExtMath Simulation Results ===");
    println!("{}", results);
