// AUTO-GENERATED simulation binary for RefinementSmoke — do not edit
...
#[derive(Parser)]
#[command(name = "simulate_refinementsmoke")]
#[command(about = "Simulation runner for the RefinementSmoke language")]
struct Args {
...
fn main() {
    ...
    let regression_path = PathBuf::from("simulate_refinementsmoke.regressions");
    ...
    if args.verbose {
        eprintln!("Running simulation for RefinementSmoke:");
    ...
    println!("=== RefinementSmoke Simulation Results ===");
    println!("{}", results);
