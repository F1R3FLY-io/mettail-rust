// AUTO-GENERATED simulation binary for BaseMath — do not edit
// Regenerated on each compilation of the language definition.
// Run with: cargo run --bin simulate_basemath -- [OPTIONS]
...
use mettail_languages::basemath::strategies::arb_num;
use mettail_runtime::Language;
use proptest::strategy::Strategy;
use std::path::PathBuf;

#[derive(Parser)]
#[command(name = "simulate_basemath")]
#[command(about = "Simulation runner for the BaseMath language")]
struct Args {
...
fn main() {
    ...
    let regression_path = PathBuf::from("simulate_basemath.regressions");
    ...
    if args.verbose {
        eprintln!("Running simulation for BaseMath:");
    ...
    println!("=== BaseMath Simulation Results ===");
    println!("{}", results);
