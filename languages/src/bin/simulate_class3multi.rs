// AUTO-GENERATED simulation binary for Class3Multi — do not edit
// Regenerated on each compilation of the language definition.
// Run with: cargo run --bin simulate_class3multi -- [OPTIONS]
...
mod class3multi;
use class3multi::strategies::arb_proc;
use class3multi::Class3MultiLanguage;
use mettail_runtime::Language;
use proptest::strategy::Strategy;
use std::path::PathBuf;

#[derive(Parser)]
#[command(name = "simulate_class3multi")]
#[command(about = "Simulation runner for the Class3Multi language")]
struct Args {
...
fn main() {
    ...
    let regression_path = PathBuf::from("simulate_class3multi.regressions");
    ...
    if args.verbose {
        eprintln!("Running simulation for Class3Multi:");
    ...
    println!("=== Class3Multi Simulation Results ===");
    println!("{}", results);
