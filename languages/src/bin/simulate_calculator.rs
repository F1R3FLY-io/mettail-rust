// AUTO-GENERATED simulation binary for Calculator — do not edit
...
#[derive(Parser)]
#[command(name = "simulate_calculator")]
#[command(about = "Simulation runner for the Calculator language")]
struct Args {
...
fn main() {
    ...
    let regression_path = PathBuf::from("simulate_calculator.regressions");
    ...
    println!("=== Calculator Simulation Results ===");
    println!("{}", results);
