// AUTO-GENERATED simulation binary for LedTest — do not edit
...
#[derive(Parser)]
#[command(name = "simulate_ledtest")]
#[command(about = "Simulation runner for the LedTest language")]
struct Args {
...
fn main() {
    ...
    let regression_path = PathBuf::from("simulate_ledtest.regressions");
    ...
    if args.verbose {
        eprintln!("Running simulation for LedTest:");
    ...
    println!("=== LedTest Simulation Results ===");
    println!("{}", results);
