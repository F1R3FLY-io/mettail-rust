// AUTO-GENERATED simulation binary for Ambient — do not edit
// Regenerated on each compilation of the language definition.
// Run with: cargo run --bin simulate_ambient -- [OPTIONS]
...
use mettail_languages::ambient::strategies::arb_proc;
use mettail_runtime::Language;
use proptest::strategy::Strategy;
use std::path::PathBuf;

#[derive(Parser)]
#[command(name = "simulate_ambient")]
#[command(about = "Simulation runner for the Ambient language")]
struct Args {
...
fn main() {
    ...
    let regression_path = PathBuf::from("simulate_ambient.regressions");
    ...
    if args.verbose {
        eprintln!("Running simulation for Ambient:");
    ...
    println!("=== Ambient Simulation Results ===");
    println!("{}", results);
