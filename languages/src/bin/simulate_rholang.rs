// AUTO-GENERATED simulation binary for Rholang — do not edit
// Regenerated on each compilation of the language definition.
// Run with: cargo run --bin simulate_rholang -- [OPTIONS]

use clap::Parser;
use mettail_languages::rholang::strategies::arb_proc;
...
#[derive(Parser)]
#[command(name = "simulate_rholang")]
#[command(about = "Simulation runner for the Rholang language")]
struct Args {
...
fn main() {
    ...
    let regression_path = PathBuf::from("simulate_rholang.regressions");
    ...
    if args.verbose {
        eprintln!("Running simulation for Rholang:");
    ...
    println!("=== Rholang Simulation Results ===");
    println!("{}", results);
